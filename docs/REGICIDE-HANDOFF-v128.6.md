# REGICIDE PVP — Handoff v128.6 (August 2026)

Read this at the start of a new chat to continue. `claude/REGICIDE-DEPLOY.md` covers hosting.
Supersedes `REGICIDE-HANDOFF-v128.5.md`, which can be deleted from the project.
...
**On disk: `v128.6 — ELEVEN PIECES AND ONE ATLAS`.** Next version: **v128.7**.
...
|---|---|---|---|---|
| `node tools/smoketest.js` | **435 PASS** (388 baseline + 17 v128.4 + 21 v128.5 + 9 v128.6) | ~100 s | — | anything |
