...
### Field-test asks
1. What frame rate does the read-out show on your actual handset? (The sandbox renders through software GL — its 4 fps means nothing.)
2. Do the floating stick and the look sensitivity (`LOOK_X`/`LOOK_Y`, 0.0060/0.0052) feel right, or does it need tuning?
3. Phone or tablet — and does the answer change whether this is worth continuing?
...
- **MOBILE, if the spike lands well**: the responsive CSS pass, touch access to the build/class/quest/blacksmith menus, and — before any of that — the unit draw-call problem above.
...
## Transcripts
Carry-forward: project doc `claude/REGICIDE-HANDOFF-v116.md`, device `docs/REGICIDE-HANDOFF-v116.md`. Delete older handoffs from the project.
