# REGICIDE PVP — Handoff v111 (July 2026)

Upload this file at the start of a new chat (or read it from the "Nutcracker Regicide" project) to continue development. Supersedes all prior handoffs. Covers **v107 THE SCORE & THE 90-SECOND ADVANCE** (recap), **v108 THE AUDIT** (recap), **v109 THE MIX FIX & THE VOICES**, **v110 THE WOLVES**, and this build: **v111 THE QUIET FIXES**. **PROTO stays 23** (v109-v111 are audio-only — v107-v111 clients are wire-compatible).
...
## Transcripts
Carry-forward: project doc `claude/REGICIDE-HANDOFF-v111.md`, device `docs/REGICIDE-HANDOFF-v111.md`. Delete older handoffs from the project.
